...
public:
    ...
    public:
         ...
         *
         * Gets channel utilization as time busy divided by time on for the channel in use.
         *
         * @param[out] channel_utilization Channel utilization value or UINT8_MAX if it cannot be
         * obtained.
         *
